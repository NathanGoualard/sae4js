...
} from "./chunk-G3ZZ4MOH.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-VXUUSICA.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-H4MQY445.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-LQCKDNT3.js";
import {
  require_pick
} from "./chunk-IMPIDJBL.js";
import {
  useEnterprise
} from "./chunk-OQKWKP6L.js";
import {
  Login
} from "./chunk-2YAHX4UZ.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-6TLISGKM.js";
import {
  ConfigurationProvider
} from "./chunk-VS54YVPR.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-QASKIWPY.js";
import {
  require_baseRest
} from "./chunk-3XY24W2K.js";
import {
  HistoryProvider
} from "./chunk-FEKNFZF3.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-3U3MAOL6.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-UHZWRBLB.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-B5JMGICV.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-AQ2OWS23.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-IRK27UO7.js";
import {
  MemoizedInputRenderer
} from "./chunk-N2XHGJ2V.js";
import {
  Form
} from "./chunk-MDLZVJ42.js";
import {
  Layouts
} from "./chunk-IN4SUWIZ.js";
import {
  getByteSize
...
} from "./chunk-O3D45NOS.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-JM3GY4G7.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-F6ETW7HN.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-MYIBHJLK.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-GLGSE6UZ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-664BQRKQ.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ALMOYNQT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-45CVQJFT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-OC2E7EHA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4ZSUQG5Z.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-VLICINS3.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-2JOT5HWX.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-J6PDP2OI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-FW4P7PJJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-L4GL3HFV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-4EOQYVZK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-TKXHM7H5.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UITPBZLG.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-IUZTP4AN.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-Q6TKW5MD.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-WG2VXXKA.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-BYDITR55.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-6IYJTX2Z.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-Q4VRH773.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-2VZINMUH.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-L6DYQ4M5.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-SRZVX4TQ.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-X6LCJQCT.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-OX2SV4NN.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-43YQSCXB.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-AXC5IO5A.js");
              return {
...
//# sourceMappingURL=chunk-JZIB42VT.js.map
